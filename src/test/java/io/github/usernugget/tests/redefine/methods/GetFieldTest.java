...
public class GetFieldTest extends AbstractRedefineTest {
  public static class PlainClass {
    ...
    public int multipleFieldInt() {
      this.fieldInt = 1;
      return (this.fieldInt << 1) | (this.fieldInt << 2) |
             (this.fieldInt << 3) | (this.fieldInt << 4);
    }
  ...
  public static final class PlainClassMapping {
    @GetField(field = "fieldInt", offset = 3)
  ...
  void testInjection() throws ClassNotFoundException {
    ...
    assertEquals(22, plain.multipleFieldInt()); // Redefined
